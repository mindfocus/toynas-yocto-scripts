...
* shellcheck script(s) and resolve violations [ab77]
* Use staging env by default [Tomás Tormo]
* Simplify public ssh addition. Do not use sudo [Tomás Tormo]
* Generate and publish AMI from the raw balenaOS image [Tomás Tormo]
